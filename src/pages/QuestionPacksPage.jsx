        ...
        <div className="flex-1 p-6 overflow-y-auto">
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            ...
            <div className="ml-auto relative">
              ...
              <input
                ...
                className="p-2.5 pl-10 rounded-lg bg-white/70 border border-gray-200 text-text-dark w-64 transition-all duration-300 hover:border-primary"
              />
            </div>
          </div>
          ...
          <div>
            {questionPacks.map((pack, index) => (
              <div
                key={index}
                className="flex flex-col sm:flex-row items-center gap-4 p-5 bg-white/90 rounded-xl mb-4 border border-gray-100 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-text-gray flex flex-wrap gap-3 text-sm">
                    ...
                    <span>
                      <i className="fas fa-clock"></i> {pack.duration}
                    </span>
                    <span>
                      <i className="fas fa-star"></i> {pack.rating}
                    </span>
                    <span
                      className={`${pack.difficultyColor} border border-white/10 rounded-md px-1 py-0.5 bg-white/10`}
                    >
                      {" "}
                      {pack.difficulty}{" "}
                    </span>
                ...
                <div className="flex gap-2">
                  <button className="py-2 px-4 border border-gray-200 rounded-md bg-transparent text-text-dark cursor-pointer transition-all duration-300 relative overflow-hidden hover:border-primary hover:text-primary hover:-translate-y-0.5">
