...
const AIVideoPage = () => {
  ...
  return (
    <div className="flex min-h-screen bg-light-bg relative overflow-hidden">
      ...
      <div
        className="absolute w-20 h-20 rounded-full bg-gradient-to-r from-primary-light to-secondary-light opacity-10 blur-2xl -z-10 animate-float top-[60%] right-[5%]"
        style={{ animationDelay: "-5s" }}
      ></div>
      <div
        className="absolute w-16 h-16 rounded-full bg-gradient-to-r from-primary-light to-secondary-light opacity-10 blur-2xl -z-10 animate-float bottom-[10%] left-[10%]"
        ...
        <div className="flex-1 p-6 overflow-y-auto">
          ...
          <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-7 mb-6 flex justify-between items-center gap-4 border border-gray-100 shadow-lg relative overflow-hidden">
            <div>
              ...
              <p className="text-text-gray">
                Practice your interview skills with our hyper-realistic AI
                interviewer. Get real-time feedback and improve your confidence
          ...
          <div className="grid lg:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-6 border border-gray-100 flex flex-col gap-4 shadow-lg relative overflow-hidden">
              <div className="flex justify-between items-center">
                ...
                <span className="flex items-center gap-2 text-primary animate-pulse">
                  <i className="fas fa-circle"></i> Live & Analyzing
                </span>
              </div>
              <div className="w-full h-80 bg-black/5 rounded-2xl flex items-center justify-center relative overflow-hidden border border-gray-100">
                <img
                  src="https://fjwp.s3.amazonaws.com/blog/wp-content/uploads/2022/01/07110707/What-Your-Video-Interview-Background-Really-Says-About-You-2.jpg"
                  alt="AI Avatar"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="flex justify-center gap-4 mt-4">
                <button className="w-14 h-14 rounded-full border-none text-text-dark text-lg cursor-pointer flex items-center justify-center transition-all duration-300 shadow-lg relative overflow-hidden hover:scale-110 bg-white/70 border border-gray-100">
            ...
            <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-6 border border-gray-100 flex flex-col gap-4 shadow-lg relative overflow-hidden">
              ...
              <div className="w-full h-80 bg-black/5 rounded-2xl flex items-center justify-center relative overflow-hidden border border-gray-100">
                <img
                  src="/img/heroalom.jpg"
                  alt="User Camera"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="flex justify-center gap-4 mt-4">
                <button className="w-14 h-14 rounded-full border-none text-white text-lg cursor-pointer flex items-center justify-center transition-all duration-300 shadow-lg relative overflow-hidden hover:scale-110 bg-gradient-to-r from-primary to-secondary">
          ...
          <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-7 mb-6 border border-gray-100 shadow-lg relative overflow-hidden">
            <div className="mb-6">
              <h3 className="text-xl font-bold text-primary mb-2 flex items-center gap-2">
                <i className="fas fa-question-circle"></i> Current Question
              </h3>
              ...
              <div className="text-5xl text-center my-5 font-bold text-primary font-mono">
                {formatTime(timer)}
              </div>
            </div>
            ...
            <div className="flex justify-center gap-4 mt-4 mb-6">
              <button
                ...
                className={`w-14 h-14 rounded-full border-none text-white text-lg cursor-pointer flex items-center justify-center transition-all duration-300 shadow-lg relative overflow-hidden hover:scale-110 ${
                  activeControl === "play"
                    ? "bg-gradient-to-r from-primary to-secondary"
                    : "bg-white/70 text-text-dark border border-gray-100"
                }`}
              >
                <i className="fas fa-play"></i>
              </button>
              <button
                onClick={() => setActiveControl("pause")}
                className={`w-14 h-14 rounded-full border-none text-white text-lg cursor-pointer flex items-center justify-center transition-all duration-300 shadow-lg relative overflow-hidden hover:scale-110 ${
                  activeControl === "pause"
                    ? "bg-gradient-to-r from-primary to-secondary"
                    : "bg-white/70 text-text-dark border border-gray-100"
              ...
              <button
                onClick={() => setActiveControl("forward")}
                className={`w-14 h-14 rounded-full border-none text-white text-lg cursor-pointer flex items-center justify-center transition-all duration-300 shadow-lg relative overflow-hidden hover:scale-110 ${
              ...
              <button
                ...
                className={`w-14 h-14 rounded-full border-none text-white text-lg cursor-pointer flex items-center justify-center transition-all duration-300 shadow-lg relative overflow-hidden hover:scale-110 bg-gradient-to-r from-red-500 to-red-600`}
              >
                <i className="fas fa-stop"></i>
              </button>
              <button
                onClick={() => setActiveControl("redo")}
                className={`w-14 h-14 rounded-full border-none text-white text-lg cursor-pointer flex items-center justify-center transition-all duration-300 shadow-lg relative overflow-hidden hover:scale-110 ${
                  activeControl === "redo"
                    ? "bg-gradient-to-r from-primary to-secondary"
                    : "bg-white/70 text-text-dark border border-gray-100"
            ...
            <p className="text-text-gray mb-5">
              Customize your interview session based on your needs. Select from
              various job roles, difficulty levels, and interview types.
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mt-5">
              {options.map((opt) => (
                <div
                  ...
                  className={`bg-white/70 p-5 rounded-2xl cursor-pointer transition-all duration-300 border relative overflow-hidden hover:-translate-y-1 hover:border-primary hover:shadow-xl ${
                    selectedOption === opt.value
                      ? "border-primary bg-primary/10 shadow-lg shadow-primary-glow"
                      : "border-transparent"
                  }`}
                >
                  <h4 className="mb-2 flex items-center gap-2 font-semibold text-text-dark">
                    <i className={`fas ${opt.icon}`}></i> {opt.title}
                  </h4>
          ...
          <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-7 mb-6 border border-gray-100 shadow-lg relative overflow-hidden">
            <h3 className="text-xl font-bold text-primary mb-2 flex items-center gap-2">
              <i className="fas fa-info-circle"></i> Session Information
            </h3>
            <p className="text-text-gray mb-4">
              This session will focus on technical questions for a Software
              Developer position. The AI will evaluate your responses and
              provide feedback on your communication skills, technical
          ...
          <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-7 mb-6 border border-gray-100 shadow-lg relative overflow-hidden">
            ...
            <p className="text-text-gray mb-5">
              Our AI is analyzing your performance in real-time. Here's how
              you're doing so far:
            </p>
