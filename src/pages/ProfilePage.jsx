...
const ProfilePage = () => {
  ...
  const [isEmailNotificationsEnabled, setIsEmailNotificationsEnabled] =
    useState(true);
  const [isPracticeRemindersEnabled, setIsPracticeRemindersEnabled] =
    useState(true);
              ...
              <div className="bg-white/90 p-6 rounded-2xl border border-gray-100 mb-6 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                <div className="flex items-center gap-4 mb-5">
                  ...
                  <div className="flex flex-col gap-2">
                    <button className="py-2.5 px-4 border border-primary rounded-lg bg-transparent text-primary cursor-pointer transition-all duration-300 inline-flex items-center gap-2 hover:bg-primary/10 hover:-translate-y-0.5">
                ...
                <div className="mb-4">
                  <label className="block text-text-gray mb-2 text-sm">
                    Full Name
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-4">
                  ...
                  <textarea
                    ...
                    className="w-full p-3 rounded-lg bg-white/70 border border-gray-200 text-text-dark resize-y transition-all duration-300 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
                  ></textarea>
                </div>
                <div className="mb-4">
                  <label className="block text-text-gray mb-2 text-sm">
                ...
                <div className="text-right mt-4">
                  <button
                    ...
                    className="py-2.5 px-4 bg-gradient-to-r from-primary to-secondary border-none rounded-lg text-white font-semibold cursor-pointer inline-flex gap-2 items-center transition-all duration-300 relative overflow-hidden hover:-translate-y-0.5 hover:shadow-lg"
                  >
              ...
              <div className="bg-white/90 p-6 rounded-2xl border border-gray-100 mb-6 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                ...
                <div className="flex items-center gap-2 mb-3">
                  <label
                    ...
                    className="relative inline-block w-12 h-6 mr-2 cursor-pointer"
                  >
                    <input
                      type="checkbox"
                ...
                <div className="text-right mt-4">
                  <button
                    ...
                    className="py-2.5 px-4 border border-primary rounded-lg bg-transparent text-primary cursor-pointer transition-all duration-300 inline-flex items-center gap-2 hover:bg-primary/10 hover:-translate-y-0.5"
                  >
              ...
              <div className="bg-gradient-to-r from-primary to-secondary text-white p-5 rounded-2xl mb-6 shadow-lg">
                ...
                <ul className="list-none mb-4">
                  <li className="mb-2 flex items-center gap-2">
                    <i className="fas fa-check text-white/90"></i> 10 hours of
                    interview practice
                  </li>
                  <li className="mb-2 flex items-center gap-2">
                    <i className="fas fa-check text-white/90"></i> AI generated
                    questions
                  </li>
                  <li className="mb-2 flex items-center gap-2">
                    <i className="fas fa-check text-white/90"></i> Basic AI
                    feedback and scoring
                  </li>
                  <li className="mb-2 flex items-center gap-2">
                    <i className="fas fa-check text-white/90"></i> Voice + text
                    hybrid mode
                  </li>
                  <li className="mb-2 flex items-center gap-2">
                    <i className="fas fa-check text-white/90"></i> Basic
                    performance tracking
                  </li>
                  <li className="mb-2 flex items-center gap-2">
                    <i className="fas fa-check text-white/90"></i> Use anytime
                    within 30 days
                  </li>
                  <li className="mb-2 flex items-center gap-2">
                    <i className="fas fa-check text-white/90"></i> Email support
                  </li>
                </ul>
                <div className="text-right mt-4">
                  <button className="py-2.5 px-4 border border-white/50 rounded-lg bg-transparent text-white cursor-pointer transition-all duration-300 inline-flex items-center gap-2 hover:bg-white/10 hover:-translate-y-0.5">
              ...
              <div className="border border-red-300 bg-red-50 p-6 rounded-2xl mb-6 shadow-lg">
                ...
                <div className="text-right mt-4 flex justify-end gap-2">
                  <button
                    ...
                    className="py-2.5 px-4 border border-danger rounded-lg bg-transparent text-danger cursor-pointer transition-all duration-300 inline-flex items-center gap-2 hover:bg-red-100 hover:-translate-y-0.5"
                  >
